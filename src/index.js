...
//           <div class="card" style="width: 28rem;">
//           <img class="card-img-top" src="${user.img_url}" alt="Card image cap">
//           <div class="card-body" style="background-image: url(https://beautifulpixels.com/wp-content/uploads/2015/11/horizon-chase-bp.jpg)">
//           <h5 class="card-title" >${user.name}</h5>
//           <p class="card-text">${user.tagline}</p>
//           </div>
//           <ul class="list-group list-group-flush" >
//           <li style="background-image: url(https://beautifulpixels.com/wp-content/uploads/2015/11/horizon-chase-bp.jpg)" class="list-group-item">$${user.money}</li>
//           <li style="background-image: url(https://beautifulpixels.com/wp-content/uploads/2015/11/horizon-chase-bp.jpg)"class="list-group-item">HP: 400</li>
//           <li style="background-image: url(https://beautifulpixels.com/wp-content/uploads/2015/11/horizon-chase-bp.jpg)"class="list-group-item">Torque: 350</li>
//           <li style="background-image: url(https://beautifulpixels.com/wp-content/uploads/2015/11/horizon-chase-bp.jpg)"class="list-group-item">Weight: 3600</li>
//           </ul>
//           <div id='start-race'>
//           <div style="background-image: url(https://beautifulpixels.com/wp-content/uploads/2015/11/horizon-chase-bp.jpg)" class="card-body">
//           <a href="#" data-id="${user.id}" class="btn btn-primary" style="background-color: black; border-color: black" >Start Race</a>
//           <a id="customize-btn" href="#" class="btn btn-primary" style="background-color: black; border-color: black">Customize</a>
//           </div>
//           </div>
